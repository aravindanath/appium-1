...
androidController.getScreenshot = function (screenshotDir, cb) {
  var localfile;

 if (typeof screenshotDir !== "undefined" && screenshotDir !== null){
...
androidController.installApp = function (appPath, cb) {
  var deviceId = this.adb.curDeviceId;
  this.adb.install(appPath, !this.args.reset, function (err) {
    if (err) {
